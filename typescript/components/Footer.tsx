      ...
      <footer className="py-2">
        <div className="text-center">
          <ul className="flex justify-center mb-3 space-x-4">
            <li>
              <Link href={{ pathname: "/terms_of_use" }} className="link link-hover">{dict.links.termsOfUse}</Link>
            </li>
            <li>
              <Link href={{ pathname: "/contact" }} className="link link-hover">{dict.links.contact}</Link>
            </li>
            <li>
