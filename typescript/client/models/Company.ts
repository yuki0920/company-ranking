...
export function CompanyFromJSONTyped(json: any, ignoreDiscriminator: boolean): Company {
  ...
  return {
    ...
    netCashProvidedByUsedInOperatingActivities:
      json["net_cash_provided_by_used_in_operating_activities"],
    netCashProvidedByUsedInInvestingActivities:
      json["net_cash_provided_by_used_in_investing_activities"],
    netCashProvidedByUsedInFinancingActivities:
      json["net_cash_provided_by_used_in_financing_activities"],
...
export function CompanyToJSON(value?: Company | null): any {
  ...
  return {
    ...
    net_cash_provided_by_used_in_investing_activities:
      value.netCashProvidedByUsedInInvestingActivities,
    net_cash_provided_by_used_in_financing_activities:
      value.netCashProvidedByUsedInFinancingActivities,
