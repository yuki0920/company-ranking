...
require (
	...
	github.com/datafuselabs/databend-go v0.7.3 // indirect
	...
	github.com/exasol/exasol-driver-go v1.0.12 // indirect
	...
	github.com/googleapis/go-sql-spanner v1.11.0 // indirect
